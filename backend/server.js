...
⚡ Твоя структура ответа:
 ...
 2. Оцени силу удара (например: "Сила — 18 единиц. Монстр пошатнулся!").
 3. Расскажи текущее состояние игрока (например: "У тебя осталось 4 попытки и 92 жизни.")
...
- Очков набрано: ${playerData.total_score}`;
    ...
    userPrompt += `\n\nСгенерируй ответ в стиле фэнтези-игры, следуя формату: опиши заклинание, назови результат, покажи статус, подбодри, заверши призывом к действию!`;
