...
1. ОСНОВНОЙ ТЕКСТ (80 символов) - яркое описание заклинания с эмодзи БЕЗ УПОМИНАНИЯ УРОНА, только атмосфера и описание заклинания
...
3. ПРИЗЫВ К ДЕЙСТВИЮ (краткий, от 80 до 100 символов) с эмодзи

КРИТИЧЕСКИ ВАЖНО: 
- ОТВЕТ ДОЛЖЕН БЫТЬ ТОЧНО 270 СИМВОЛОВ (не больше, не меньше)
- В ОСНОВНОМ ТЕКСТЕ НЕ УПОМИНАЙ УРОН - только опиши заклинание и атмосферу
...
- Урон игрока в этом ходу: ${livesLost}`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      max_tokens: 200, // Уменьшаем для соответствия лимиту в 270 символов
