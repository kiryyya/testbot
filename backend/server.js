...
1. ОСНОВНОЙ ТЕКСТ (80 символов) - яркое описание заклинания с эмодзи и результата, допустим на что похоже заклинание и сколько жизней у монстра отнялось [ТОЧНО ТО КОЛИЧЕСТВО ЧТО ПЕРЕДАНО В ПРОМПТЕ damageToMonster]
...
- Если урон = 0, пиши "⚔️ Урон монстру = 0"
...
- Урон игрока в этом ходу: ${livesLost}`;
    ...
    userPrompt += `\n\nСгенерируй яркий и эмоциональный ответ в стиле фэнтези-игры, используя ТОЛЬКО переданные выше данные. Будь креативным, используй РАЗНЫЕ эмодзи каждый раз, создавай уникальную атмосферу! ОТВЕТ ДОЛЖЕН БЫТЬ ТОЧНО 270 СИМВОЛОВ! Считай символы и корректируй текст для точного соответствия.`;
