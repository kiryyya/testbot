...
1. ОСНОВНОЙ ТЕКСТ (до 80 символов) - яркое описание заклинания с эмодзи и результата
2. СПИСОК МЕТРИК в формате:
   - ⚔️ Урон монстру = [ТОЧНО ТОТ УРОН ЧТО ПЕРЕДАН В ПРОМПТЕ]
   - 💜 Жизней осталось [ТОЧНО ТО КОЛИЧЕСТВО ЧТО ПЕРЕДАНО В ПРОМПТЕ]
   - 🎯 Попыток осталось [ТОЧНО ТО КОЛИЧЕСТВО ЧТО ПЕРЕДАНО В ПРОМПТЕ]
3. ПРИЗЫВ К ДЕЙСТВИЮ (краткий, до 2 символов) с эмодзи
